    ...
    try:
        ...
        try:
            ...
            if lark_success:
                ...
                logger.warning(f"Failed to append to Lark Bitable (submission still saved to database): {id_number}")
        except Exception as e:
            # Log error but don't fail the request
            logger.error(f"Error appending to Lark Bitable: {str(e)}. Submission saved to database.")
